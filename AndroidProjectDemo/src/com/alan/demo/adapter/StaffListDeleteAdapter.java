...
public class StaffListDeleteAdapter extends BaseAdapter {

	private Context context;
	private List<Staff> staffList;
	private LayoutInflater mInflater;

	public StaffListDeleteAdapter(Context context, List<Staff> staffList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			convertView = mInflater.inflate(R.layout.item_staff_list_delete_layout,
					null);
			...
			holder.modifyBtn = (Button) convertView
					.findViewById(R.id.item_staff_modify);
