...
public class StaffListModifyAdapter extends BaseAdapter {

	private Context context;
	private List<Staff> staffList;
	private LayoutInflater mInflater;

	public StaffListModifyAdapter(Context context, List<Staff> staffList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			convertView = mInflater.inflate(R.layout.item_staff_list_modify_layout,
					null);
