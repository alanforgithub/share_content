...
public class FocusManager implements Camera.OnOrientationListener , Camera.OnParametersReadyListener {
    ...
    public void onSingleTapUp(int x, int y) {
        ...
        if (mMirror) {  //modify by ChMX to focus correct when in front camera
			calculateTapArea(focusWidth, focusHeight, 1f, previewWidth - x, previewHeight - y, previewWidth, previewHeight,
                mFocusArea.get(0).rect);
        	calculateTapArea(focusWidth, focusHeight, 1.5f, previewWidth - x, previewHeight - y, previewWidth, previewHeight,
