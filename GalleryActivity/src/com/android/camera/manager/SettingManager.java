...
public class SettingManager extends ViewManager implements View.OnClickListener,
    ...
    protected View getView() {
        ...
        mIndicator.setOnClickListener(this);     //modify by wgb , refuse the setting icon click
        return view;
    }
    ...
    public void showSetting() {
        ...
        if (getContext().isFullScreen()) {
            ...
            if (!mShowingContainer && preferenceGroup != null && getContext().isNormalViewState()) {
                ...
                //mIndicator.setImageResource(R.drawable.ic_setting_focus);    //modify by wgb  hide setting icon
            }
            setChildrenClickable(true);
        }
        
        Log.i("size", "size = "+mPager.getLeft()+","+mPager.getRight()+","+mPager.getTop()+","+mPager.getBottom());
    ...
    private void initializeSettings() {
        ...
        if (getContext().getPreferenceGroup() != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                for(int k = 0;k<holder.mSettingKeys.length;k++){
                	Log.i("wgb", "k = "+holder.mSettingKeys[k]);
                	
                	
                	String str[] = SettingChecker.getSettingKeys(holder.mSettingKeys);
    ...
    public void hideSetting() {
        ...
        if (mShowingContainer && mSettingLayout != null) {
            ...
            //mIndicator.setImageResource(R.drawable.ic_setting_normal);  //modify by wgb   hide setting icon
    ...
    private class Holder {
		...
		public String toString() {
			return "Holder [mIndicatorKey=" + mIndicatorKey
					+ ", mIndicatorIconRes=" + mIndicatorIconRes
					+ ", mSettingKeys=" + Arrays.toString(mSettingKeys) + "]";
		}
