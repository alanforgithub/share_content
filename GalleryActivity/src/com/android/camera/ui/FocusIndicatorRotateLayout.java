...
public class FocusIndicatorRotateLayout extends RotateLayout implements FocusIndicator {
    ...
    private static final int SCALING_UP_TIME = 200;  //modify by ChMX to shorten the time of focusing action
    ...
    public void showStart() {
        ...
        if (mState == STATE_IDLE) {
            ...
            //modify by ChMX to shorten the time of focusing action
            animate().withLayer().setDuration(SCALING_UP_TIME)
            .scaleX(1.5f).scaleY(1.5f).withEndAction(new Runnable() {
