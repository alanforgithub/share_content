...
public class GestureActor extends SymbolActor {
    ...
    private static final boolean USE_FLASH_MODE_NOTIFY = false;
    ...
    private static final int GESTRUE_VOLUME = 100;
    private static final int GESTRUE_DELAY = 300;
        ...
        public void onGesture() {
            ...
            if (!mCameraClosed && (mCamera.getViewState() != Camera.VIEW_STATE_SETTING)) {
                ...
                if (mGestureTone != null) {
                    mGestureTone.startTone(ToneGenerator.TONE_PROP_BEEP2, GESTRUE_DELAY);
                }
