...
//        ROW_SETTING_CONTRAST,//common
    ...
    private static String getDefaultValueFromXml(Context context, int row) {
        ...
        if (value == null) {
            ...
            if (CameraSettings.FIX_CONTINUOUS_SHOT_NUMBER && 
                    row == ROW_SETTING_CONTINUOUS) {
                value = CameraSettings.FIXED_CONTINUOUS_SHOT_NUMBER;
            } else if (!CameraSettings.SUPPORTED_SHOW_CONINUOUS_SHOT_NUMBER && 
                    row == ROW_SETTING_CONTINUOUS) {
