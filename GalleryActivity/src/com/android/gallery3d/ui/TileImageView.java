...
public class TileImageView extends GLView {
    ...
    private static final boolean SKIP_SHOW_TILE_PROCESS = true;
    ...
    private static final int TILE_DECODER_NUM = 4;
    ...
    public static boolean isHighResolution(Context context) {
        ...
        return metrics.heightPixels >= 1920 ||  metrics.widthPixels >= 1920;
    }
    ...
    public void drawTile(GLCanvas canvas,
        ...
        if (tile != null) {
            ...
            if (SKIP_SHOW_TILE_PROCESS && mRenderComplete) {
