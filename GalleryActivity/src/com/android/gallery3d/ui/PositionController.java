...
public class PositionController {
    ...
    private static final boolean PLAY_SNAP_ANIMATION_FIRST_LAUNCH = false;
    ...
    public static final int SNAPBACK_ANIMATION_TIME = PLAY_SNAP_ANIMATION_FIRST_LAUNCH ? 800 : 600;
    ...
    private boolean setBoxSize(int i, int width, int height, boolean isViewSize) {
        ...
        if ((wasViewSize && !isViewSize) || !mFilmMode) {
            if (PLAY_SNAP_ANIMATION_FIRST_LAUNCH && 
                    b.mAnimationStartTime != NO_ANIMATION &&
                    b.mAnimationKind == ANIM_KIND_OPENING) {
                b.mAnimationStartTime = NO_ANIMATION;
                b.mScaleMin = getMinimalScale(b);
                b.mScaleMax = getMaximalScale(b);
                if (ratio > 0.0f) {
                    b.mCurrentScale = b.mCurrentScale * ratio;
                } else {
                    b.mCurrentScale = 0.0f;
                }
                b.doAnimation(b.mToY, b.mScaleMin, ANIM_KIND_SNAPBACK);
            } else {
