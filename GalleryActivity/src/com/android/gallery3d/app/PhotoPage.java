...
public class PhotoPage extends ActivityState implements
    ...
    private static final int MSG_LOCK_ORIENTATION_SPECIFIC = 135;
    ...
    public void onCreate(Bundle data, Bundle restoreState) {
        ...
        mHandler = new SynchronizedHandler(mActivity.getGLRoot()) {
            ...
            public void handleMessage(Message message) {
                switch (message.what) {
                    ...
                    case MSG_LOCK_ORIENTATION_SPECIFIC: {
                        mOrientationManager.lockOrientationSpecific(message.arg1);
                        break;
                    }
        ...
        if (mSetPathString != null) {
            ...
            if (mAppBridge != null) {
                ...
                mOrientationManager.lockOrientationSpecific(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
...
//            }, mActivity);
    ...
    public void lockOrientationSpecific(int oritation) {
        if(isLockCameraOritation == true) {
            mHandler.obtainMessage(MSG_LOCK_ORIENTATION_SPECIFIC, oritation, 0).sendToTarget();
        }
    }
    ...
    public void playVideo(Activity activity, Uri uri, String title) {
        ...
        try {
            ...
            intent.setComponent(new ComponentName("com.android.gallery3d", "com.android.gallery3d.app.MovieActivity"));  //add by ChMX
